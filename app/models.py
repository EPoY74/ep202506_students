...
class StudentExtraInfo(Base):
    ...
    info_value: Mapped[str] = mapped_column(String, nullable=False)
...
class Student(Base):
    ...
    status: Mapped["StudentStatus"] = relationship("StudentStatus", back_populates="students")
    extra_info: Mapped[list['StudentExtraInfo']] = relationship("StudentExtraInfo", back_populates="student")